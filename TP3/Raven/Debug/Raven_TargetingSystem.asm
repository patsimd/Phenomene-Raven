; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.21005.1 
	...
	TITLE	C:\Users\patsi_000\Documents\GitHub\Phenomene-Raven\TP3\Raven\Raven_TargetingSystem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\patsi_000\documents\github\phenomene-raven\tp3\raven\raven_targetingsystem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
...
; 20   : 
; 21   : 	//fetch leader's target if it exists
; 22   : 	if (m_pOwner->GetLeader() != nullptr){
...
; 23   : 		if (m_pOwner->GetTargetSys()->GetTarget() != 0)
...
; 24   : 		{
; 25   : 			m_pCurrentTarget = m_pOwner->GetTargetSys()->GetTarget();
...
; 29   : 
; 30   : 
; 31   :   double ClosestDistSoFar = MaxDouble;

	movsd	xmm0, QWORD PTR _MaxDouble
	movsd	QWORD PTR _ClosestDistSoFar$[ebp], xmm0

; 32   :   m_pCurrentTarget       = 0;

	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+4], 0

; 33   : 
; 34   :   //grab a list of all the opponents the owner can sense
; 35   :   std::list<Raven_Bot*> SensedBots;
...
; 36   :   SensedBots = m_pOwner->GetSensoryMem()->GetListOfRecentlySensedOpponents();
...
; 37   :   
; 38   :   std::list<Raven_Bot*>::const_iterator curBot = SensedBots.begin();
...
; 39   :   for (curBot; curBot != SensedBots.end(); ++curBot)
...
; 40   :   {
; 41   :     //make sure the bot is alive and that it is not the owner
; 42   :     if ((*curBot)->isAlive() && (*curBot != m_pOwner) )
...
; 43   :     {
; 44   : 	  // Check for teams
; 45   : 		if (! ((*curBot)->getTeam() && m_pOwner->getTeam()))
...
; 46   : 		{
; 47   : 		  double dist = Vec2DDistanceSq((*curBot)->Pos(), m_pOwner->Pos());
...
; 50   : 		  {
; 51   : 			ClosestDistSoFar = dist;

	movsd	xmm0, QWORD PTR _dist$8[ebp]
	movsd	QWORD PTR _ClosestDistSoFar$[ebp], xmm0

; 52   : 			m_pCurrentTarget = *curBot;
