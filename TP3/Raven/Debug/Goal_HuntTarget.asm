; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.21005.1 
	...
	TITLE	C:\Users\patsi_000\Documents\GitHub\Phenomene-Raven\TP3\Raven\goals\Goal_HuntTarget.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__unwindtable$?Activate@Goal_HuntTarget@@UAEXXZ DD 0ffffffffH
	...
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?Activate@Goal_HuntTarget@@UAEXXZ$2
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\patsi_000\documents\github\phenomene-raven\tp3\raven\goals\goal_movetoposition.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\patsi_000\documents\github\phenomene-raven\tp3\raven\goals\goal_explore.h
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\patsi_000\documents\github\phenomene-raven\tp3\raven\goals\goal_hunttarget.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
...
; 80   : //#define SHOW_LAST_RECORDED_POSITION
; 81   : #ifdef SHOW_LAST_RECORDED_POSITION
; 82   :   //render last recorded position as a green circle
; 83   :   if (m_pOwner->GetTargetSys()->isTargetPresent())
; 84   :   {
; 85   :     gdi->GreenPen();
; 86   :     gdi->RedBrush();
; 87   :     gdi->Circle(m_pOwner->GetTargetSys()->GetLastRecordedPosition(), 3);
; 88   :   }
; 89   : #endif
; 90   : 
; 91   :  //forward the request to the subgoals
; 92   :   Goal_Composite<Raven_Bot>::Render();
...
; 61   :   //if status is inactive, call Activate()
; 62   :   ActivateIfInactive();
...
; 65   : 
; 66   :   //if target is in view this goal is satisfied
; 67   :   if (m_pOwner->GetTargetSys()->isTargetWithinFOV())
...
; 32   :     if (lrp.isZero() || m_pOwner->isAtPosition(lrp))
	...
	lea	ecx, DWORD PTR _lrp$9[ebp]
	call	?isZero@Vector2D@@QBE_NXZ		; Vector2D::isZero
	movzx	eax, al
	test	eax, eax
	jne	SHORT $LN5@Activate
	sub	esp, 16					; 00000010H
	mov	ecx, esp
	mov	edx, DWORD PTR _lrp$9[ebp]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR _lrp$9[ebp+4]
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR _lrp$9[ebp+8]
	mov	DWORD PTR [ecx+8], edx
	mov	eax, DWORD PTR _lrp$9[ebp+12]
	mov	DWORD PTR [ecx+12], eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
...
; 39   :     {
; 40   : 		if (m_pOwner->GetLeader() != nullptr){
...
; 41   : 			AddSubgoal(new Goal_MoveToPosition(m_pOwner, m_pOwner->GetLeader()->Pos()));
...
; 44   : 			AddSubgoal(new Goal_MoveToPosition(m_pOwner, lrp));
	...
	sub	esp, 16					; 00000010H
	mov	eax, esp
	mov	ecx, DWORD PTR _lrp$9[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR _lrp$9[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR _lrp$9[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR _lrp$9[ebp+12]
...
; 47   :   }
; 48   : 
; 49   :   //if their is no active target then this goal can be removed from the queue
; 50   :   else
...
; 55   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN22@Activate
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
__unwindfunclet$?Activate@Goal_HuntTarget@@UAEXXZ$1:
	...
	pop	ecx
	ret	0
__unwindfunclet$?Activate@Goal_HuntTarget@@UAEXXZ$2:
	mov	eax, DWORD PTR $T2[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\patsi_000\documents\github\phenomene-raven\tp3\common\goals\goal_composite.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\patsi_000\documents\github\phenomene-raven\tp3\common\goals\goal.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\patsi_000\documents\github\phenomene-raven\tp3\raven\raven_targetingsystem.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\patsi_000\documents\github\phenomene-raven\tp3\common\game\basegameentity.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\patsi_000\documents\github\phenomene-raven\tp3\common\misc\cgdi.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\patsi_000\documents\github\phenomene-raven\tp3\common\2d\vector2d.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\patsi_000\documents\github\phenomene-raven\tp3\common\misc\utils.h
