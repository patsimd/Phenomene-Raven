; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.21005.1 
	...
	TITLE	C:\Users\patsi_000\Documents\GitHub\Phenomene-Raven\TP3\Raven\goals\Goal_Explore.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__unwindtable$?Activate@Goal_Explore@@UAEXXZ DD 0ffffffffH
	...
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?Activate@Goal_Explore@@UAEXXZ$1
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\patsi_000\documents\github\phenomene-raven\tp3\raven\goals\goal_explore.cpp
_TEXT	SEGMENT
tv156 = -48						; size = 4
tv168 = -44						; size = 4
tv167 = -40						; size = 4
...
; 64   :   //first, pass the message down the goal hierarchy
; 65   :   bool bHandled = ForwardMessageToFrontMostSubgoal(msg);
...
; 66   : 
; 67   :   //if the msg was not handled, test to see if this goal can handle it
; 68   :   if (bHandled == false)
...
; 71   :     {
; 72   :     case Msg_PathReady:
; 73   : 
; 74   :       //clear any existing goals
; 75   :       RemoveAllSubgoals();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?RemoveAllSubgoals@?$Goal_Composite@VRaven_Bot@@@@QAEXXZ ; Goal_Composite<Raven_Bot>::RemoveAllSubgoals

; 76   : 
; 77   :       AddSubgoal(new Goal_FollowPath(m_pOwner,
; 78   :                                      m_pOwner->GetPathPlanner()->GetPath()));
...
; 50   :   //if status is inactive, call Activate()
; 51   :   ActivateIfInactive();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?ActivateIfInactive@?$Goal@VRaven_Bot@@@@IAEXXZ ; Goal<Raven_Bot>::ActivateIfInactive

; 52   : 
; 53   :   //process the subgoals
; 54   :   m_iStatus = ProcessSubgoals();
...
; 37   :   //has been found
; 38   :   if (m_pOwner->GetLeader() != nullptr){
...
; 39   : 	  AddSubgoal(new Goal_SeekToPosition(m_pOwner, m_pOwner->GetLeader()->Pos()));
...
; 42   : 	  AddSubgoal(new Goal_SeekToPosition(m_pOwner, m_CurrentDestination));
...
__unwindfunclet$?Activate@Goal_Explore@@UAEXXZ$0:
	...
	pop	ecx
	ret	0
__unwindfunclet$?Activate@Goal_Explore@@UAEXXZ$1:
	mov	eax, DWORD PTR $T2[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
