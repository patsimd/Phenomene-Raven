...
//------------------------------- Activate ------------------------------------
//-----------------------------------------------------------------------------
void Goal_DodgeSideToSideToGetItem::Activate()
{
	m_iStatus = active;
...
//-------------------------- Process ------------------------------------------
//-----------------------------------------------------------------------------
int Goal_DodgeSideToSideToGetItem::Process()
{
...
//---------------------------- Terminate --------------------------------------
//-----------------------------------------------------------------------------
void Goal_DodgeSideToSideToGetItem::Terminate()
{
...
void Goal_DodgeSideToSideToGetItem::Render()
{
	//#define SHOW_TARGET
#ifdef SHOW_TARGET
	gdi->OrangePen();
